    ...
    return (
        <div className="space-y-4 sm:space-y-6">
            ...
            <div className="page-header">
                <div>
                    <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Laporan Laba Rugi</h1>
                    <p className="text-sm text-gray-500">Analisis pendapatan dan pengeluaran</p>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                <div className="card p-4 sm:p-5">
                    <div className="flex items-center justify-between mb-2">
                        <span className="text-xs sm:text-sm text-gray-500">Penjualan Bersih</span>
                        <TrendingUp className="h-4 w-4 text-green-500" />
                    </div>
                    <p className="text-xl sm:text-2xl font-bold text-gray-900">{formatCurrency(data.revenue.netSales)}</p>
                </div>
                <div className="card p-4 sm:p-5">
                    <div className="flex items-center justify-between mb-2">
                        <span className="text-xs sm:text-sm text-gray-500">Laba Kotor</span>
                        <TrendingUp className="h-4 w-4 text-blue-500" />
                    </div>
                    <p className="text-xl sm:text-2xl font-bold text-gray-900">{formatCurrency(data.grossProfit)}</p>
                </div>
                <div className="card p-4 sm:p-5">
                    <div className="flex items-center justify-between mb-2">
                        <span className="text-xs sm:text-sm text-gray-500">Laba Bersih</span>
                        <span className="text-xs text-green-600 font-medium">{data.profitMargin}%</span>
                    </div>
                    <p className="text-xl sm:text-2xl font-bold text-green-600">{formatCurrency(data.netProfit)}</p>
                </div>
            </div>
            ...
            <div className="card overflow-hidden">
                <div className="p-4 sm:p-5 border-b border-gray-200 bg-gray-50">
                    <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Laporan Laba Rugi - {data.period}</h3>
                </div>
                <div className="p-4 sm:p-5 space-y-4 sm:space-y-6">
                    {/* Revenue Section */}
                    <div>
                        <h4 className="font-medium text-gray-900 mb-2 sm:mb-3 text-sm sm:text-base">Pendapatan</h4>
                        <div className="space-y-2 pl-2 sm:pl-4">
                            ...
                            <div className="flex justify-between py-2 bg-gray-50 px-2 rounded font-medium text-sm">
                    ...
                    {/* COGS Section */}
                    <div>
                        <h4 className="font-medium text-gray-900 mb-2 sm:mb-3 text-sm sm:text-base">Harga Pokok (HPP)</h4>
                        <div className="space-y-2 pl-2 sm:pl-4">
                            <div className="flex justify-between py-2 border-b border-gray-100 text-sm">
                    ...
                    {/* Gross Profit */}
                    <div className="flex justify-between py-3 bg-blue-50 px-3 sm:px-4 rounded-lg font-semibold text-sm sm:text-base">
                    ...
                    {/* Operating Expenses */}
                    <div>
                        <h4 className="font-medium text-gray-900 mb-2 sm:mb-3 text-sm sm:text-base">Beban Operasional</h4>
                        <div className="space-y-2 pl-2 sm:pl-4">
                            <div className="flex justify-between py-2 border-b border-gray-100 text-sm">
                    ...
                    {/* Net Profit */}
                    <div className="flex justify-between py-4 bg-green-50 px-3 sm:px-4 rounded-lg font-bold text-base sm:text-lg">
